# owner-architect-agreement-aia-b101 — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `55-owner-architect-agreement-aia-b101.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 55-owner-architect-agreement-aia-b101.zip
```
...
cp 55-owner-architect-agreement-aia-b101.md .claude/agents/
...
```
Use the owner-architect-agreement-aia-b101 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 55-owner-architect-agreement-aia-b101.md
# OR
...
```bash
rm .claude/agents/55-owner-architect-agreement-aia-b101.md
# OR
rm ~/.claude/agents/55-owner-architect-agreement-aia-b101.md
```
