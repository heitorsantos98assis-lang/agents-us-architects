# owner-architect-agreement-aia-b101 — Codex Agent
...
cp 55-owner-architect-agreement-aia-b101.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 55-owner-architect-agreement-aia-b101.md
# OR
...
```bash
rm .codex/agents/55-owner-architect-agreement-aia-b101.md
# OR
rm .codex/agents/55-owner-architect-agreement-aia-b101.md
```
