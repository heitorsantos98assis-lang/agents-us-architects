# construction-project-registration-payroll — Codex Agent
...
cp 36-construction-project-registration-payroll.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 36-construction-project-registration-payroll.md
# OR
...
```bash
rm .codex/agents/36-construction-project-registration-payroll.md
# OR
rm .codex/agents/36-construction-project-registration-payroll.md
```
