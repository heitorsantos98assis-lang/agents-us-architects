# construction-project-registration-payroll — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `36-construction-project-registration-payroll.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 36-construction-project-registration-payroll.zip
```
...
cp 36-construction-project-registration-payroll.md .claude/agents/
...
```
Use the construction-project-registration-payroll subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 36-construction-project-registration-payroll.md
# OR
...
```bash
rm .claude/agents/36-construction-project-registration-payroll.md
# OR
rm ~/.claude/agents/36-construction-project-registration-payroll.md
```
