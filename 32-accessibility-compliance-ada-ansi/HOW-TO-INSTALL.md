# accessibility-compliance-ada-ansi — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `32-accessibility-compliance-ada-ansi.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 32-accessibility-compliance-ada-ansi.zip
```
...
cp 32-accessibility-compliance-ada-ansi.md .claude/agents/
...
```
Use the accessibility-compliance-ada-ansi subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 32-accessibility-compliance-ada-ansi.md
# OR
...
```bash
rm .claude/agents/32-accessibility-compliance-ada-ansi.md
# OR
rm ~/.claude/agents/32-accessibility-compliance-ada-ansi.md
```
