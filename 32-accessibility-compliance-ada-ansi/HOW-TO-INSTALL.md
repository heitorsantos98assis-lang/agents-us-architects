# accessibility-compliance-ada-ansi — Codex Agent
...
cp 32-accessibility-compliance-ada-ansi.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 32-accessibility-compliance-ada-ansi.md
# OR
...
```bash
rm .codex/agents/32-accessibility-compliance-ada-ansi.md
# OR
rm .codex/agents/32-accessibility-compliance-ada-ansi.md
```
