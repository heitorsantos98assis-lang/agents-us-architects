# architectural-acoustics-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `45-architectural-acoustics-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 45-architectural-acoustics-design.zip
```
...
cp 45-architectural-acoustics-design.md .claude/agents/
...
```
Use the architectural-acoustics-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 45-architectural-acoustics-design.md
# OR
...
```bash
rm .claude/agents/45-architectural-acoustics-design.md
# OR
rm ~/.claude/agents/45-architectural-acoustics-design.md
```
