# architectural-acoustics-design — Codex Agent
...
cp 45-architectural-acoustics-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 45-architectural-acoustics-design.md
# OR
...
```bash
rm .codex/agents/45-architectural-acoustics-design.md
# OR
rm .codex/agents/45-architectural-acoustics-design.md
```
