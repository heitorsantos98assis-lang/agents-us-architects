# means-of-egress-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `39-means-of-egress-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 39-means-of-egress-design.zip
```
...
cp 39-means-of-egress-design.md .claude/agents/
...
```
Use the means-of-egress-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 39-means-of-egress-design.md
# OR
...
```bash
rm .claude/agents/39-means-of-egress-design.md
# OR
rm ~/.claude/agents/39-means-of-egress-design.md
```
