# means-of-egress-design — Codex Agent
...
cp 39-means-of-egress-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 39-means-of-egress-design.md
# OR
...
```bash
rm .codex/agents/39-means-of-egress-design.md
# OR
rm .codex/agents/39-means-of-egress-design.md
```
