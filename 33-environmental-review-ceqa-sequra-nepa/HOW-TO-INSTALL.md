# environmental-review-ceqa-sequra-nepa — Codex Agent
...
cp 33-environmental-review-ceqa-sequra-nepa.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 33-environmental-review-ceqa-sequra-nepa.md
# OR
...
```bash
rm .codex/agents/33-environmental-review-ceqa-sequra-nepa.md
# OR
rm .codex/agents/33-environmental-review-ceqa-sequra-nepa.md
```
