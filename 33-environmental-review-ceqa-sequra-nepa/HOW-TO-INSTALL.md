# environmental-review-ceqa-sequra-nepa — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `33-environmental-review-ceqa-sequra-nepa.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 33-environmental-review-ceqa-sequra-nepa.zip
```
...
cp 33-environmental-review-ceqa-sequra-nepa.md .claude/agents/
...
```
Use the environmental-review-ceqa-sequra-nepa subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 33-environmental-review-ceqa-sequra-nepa.md
# OR
...
```bash
rm .claude/agents/33-environmental-review-ceqa-sequra-nepa.md
# OR
rm ~/.claude/agents/33-environmental-review-ceqa-sequra-nepa.md
```
