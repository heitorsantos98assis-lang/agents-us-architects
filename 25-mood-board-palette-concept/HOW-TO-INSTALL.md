# 25-mood-board-palette-concept — Codex Agent
...
cp 25-mood-board-palette-concept.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 25-mood-board-palette-concept.md
# OR
...
```bash
rm .codex/agents/25-mood-board-palette-concept.md
# OR
rm .codex/agents/25-mood-board-palette-concept.md
```
