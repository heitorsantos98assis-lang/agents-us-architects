# 25-mood-board-palette-concept — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `25-mood-board-palette-concept.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 25-mood-board-palette-concept.zip
```
...
cp 25-mood-board-palette-concept.md .claude/agents/
...
```
Use the mood-board-palette-concept subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 25-mood-board-palette-concept.md
# OR
...
```bash
rm .claude/agents/25-mood-board-palette-concept.md
# OR
rm ~/.claude/agents/25-mood-board-palette-concept.md
```
