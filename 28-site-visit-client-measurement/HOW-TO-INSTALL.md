# 28-site-visit-client-measurement — Claude Code Agent
...
cp 28-site-visit-client-measurement.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 28-site-visit-client-measurement.md
# OR
...
```bash
rm .claude/agents/28-site-visit-client-measurement.md
# OR
rm ~/.claude/agents/28-site-visit-client-measurement.md
```
