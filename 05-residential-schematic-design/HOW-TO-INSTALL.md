# 05-residential-schematic-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `05-residential-schematic-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 05-residential-schematic-design.zip
```
...
cp 05-residential-schematic-design.md .claude/agents/
...
```
Use the residential-schematic-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 05-residential-schematic-design.md
# OR
...
```bash
rm .claude/agents/05-residential-schematic-design.md
# OR
rm ~/.claude/agents/05-residential-schematic-design.md
```
