# 05-residential-schematic-design — Codex Agent
...
cp 05-residential-schematic-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 05-residential-schematic-design.md
# OR
...
```bash
rm .codex/agents/05-residential-schematic-design.md
# OR
rm .codex/agents/05-residential-schematic-design.md
```
