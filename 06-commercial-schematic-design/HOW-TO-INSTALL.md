# 06-commercial-schematic-design — Codex Agent
...
cp 06-commercial-schematic-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 06-commercial-schematic-design.md
# OR
...
```bash
rm .codex/agents/06-commercial-schematic-design.md
# OR
rm .codex/agents/06-commercial-schematic-design.md
```
