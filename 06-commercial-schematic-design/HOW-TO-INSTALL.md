# 06-commercial-schematic-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `06-commercial-schematic-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 06-commercial-schematic-design.zip
```
...
cp 06-commercial-schematic-design.md .claude/agents/
...
```
Use the commercial-schematic-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 06-commercial-schematic-design.md
# OR
...
```bash
rm .claude/agents/06-commercial-schematic-design.md
# OR
rm ~/.claude/agents/06-commercial-schematic-design.md
```
