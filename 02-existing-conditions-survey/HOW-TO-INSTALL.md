# 02-existing-conditions-survey — Claude Code Agent
...
cp 02-existing-conditions-survey.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 02-existing-conditions-survey.md
# OR
...
```bash
rm .claude/agents/02-existing-conditions-survey.md
# OR
rm ~/.claude/agents/02-existing-conditions-survey.md
```
