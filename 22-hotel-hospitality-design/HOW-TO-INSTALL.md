# 22-hotel-hospitality-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `22-hotel-hospitality-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 22-hotel-hospitality-design.zip
```
...
cp 22-hotel-hospitality-design.md .claude/agents/
...
```
Use the hotel-hospitality-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 22-hotel-hospitality-design.md
# OR
...
```bash
rm .claude/agents/22-hotel-hospitality-design.md
# OR
rm ~/.claude/agents/22-hotel-hospitality-design.md
```
