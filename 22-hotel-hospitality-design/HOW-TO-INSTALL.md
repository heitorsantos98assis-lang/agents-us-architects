# 22-hotel-hospitality-design — Codex Agent
...
cp 22-hotel-hospitality-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 22-hotel-hospitality-design.md
# OR
...
```bash
rm .codex/agents/22-hotel-hospitality-design.md
# OR
rm .codex/agents/22-hotel-hospitality-design.md
```
