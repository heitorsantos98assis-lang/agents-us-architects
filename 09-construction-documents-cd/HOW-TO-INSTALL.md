...
cp 09-construction-documents-cd.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 09-construction-documents-cd.md
# OR
...
```bash
rm .claude/agents/09-construction-documents-cd.md
# OR
rm ~/.claude/agents/09-construction-documents-cd.md
```
