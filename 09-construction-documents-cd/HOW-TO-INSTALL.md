# 09-construction-documents-cd — Codex Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `09-construction-documents-cd.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 09-construction-documents-cd.zip
```
...
cp 09-construction-documents-cd.md .codex/agents/
...
```
Use the construction-documents-cd subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 09-construction-documents-cd.md
# OR
...
```bash
rm .codex/agents/09-construction-documents-cd.md
# OR
rm .codex/agents/09-construction-documents-cd.md
```
