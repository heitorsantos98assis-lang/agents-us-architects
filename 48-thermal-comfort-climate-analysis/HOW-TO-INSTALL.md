# thermal-comfort-climate-analysis — Codex Agent
...
cp 48-thermal-comfort-climate-analysis.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 48-thermal-comfort-climate-analysis.md
# OR
...
```bash
rm .codex/agents/48-thermal-comfort-climate-analysis.md
# OR
rm .codex/agents/48-thermal-comfort-climate-analysis.md
```
