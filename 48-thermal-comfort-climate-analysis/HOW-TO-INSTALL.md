# thermal-comfort-climate-analysis — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `48-thermal-comfort-climate-analysis.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 48-thermal-comfort-climate-analysis.zip
```
...
cp 48-thermal-comfort-climate-analysis.md .claude/agents/
...
```
Use the thermal-comfort-climate-analysis subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 48-thermal-comfort-climate-analysis.md
# OR
...
```bash
rm .claude/agents/48-thermal-comfort-climate-analysis.md
# OR
rm ~/.claude/agents/48-thermal-comfort-climate-analysis.md
```
