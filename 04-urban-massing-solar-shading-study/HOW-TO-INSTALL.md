# 04-urban-massing-solar-shading-study — Codex Agent
...
cp 04-urban-massing-solar-shading-study.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 04-urban-massing-solar-shading-study.md
# OR
...
```bash
rm .codex/agents/04-urban-massing-solar-shading-study.md
# OR
rm .codex/agents/04-urban-massing-solar-shading-study.md
```
