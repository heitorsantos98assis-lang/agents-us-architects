# 04-urban-massing-solar-shading-study — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `04-urban-massing-solar-shading-study.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 04-urban-massing-solar-shading-study.zip
```
...
cp 04-urban-massing-solar-shading-study.md .claude/agents/
...
```
Use the urban-massing-solar-shading-study subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 04-urban-massing-solar-shading-study.md
# OR
...
```bash
rm .claude/agents/04-urban-massing-solar-shading-study.md
# OR
rm ~/.claude/agents/04-urban-massing-solar-shading-study.md
```
