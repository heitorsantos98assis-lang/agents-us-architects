# unpermitted-work-legalization — Codex Agent
...
cp 35-unpermitted-work-legalization.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 35-unpermitted-work-legalization.md
# OR
...
```bash
rm .codex/agents/35-unpermitted-work-legalization.md
# OR
rm .codex/agents/35-unpermitted-work-legalization.md
```
