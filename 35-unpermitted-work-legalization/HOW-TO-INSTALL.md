# unpermitted-work-legalization — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `35-unpermitted-work-legalization.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 35-unpermitted-work-legalization.zip
```
...
cp 35-unpermitted-work-legalization.md .claude/agents/
...
```
Use the unpermitted-work-legalization subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 35-unpermitted-work-legalization.md
# OR
...
```bash
rm .claude/agents/35-unpermitted-work-legalization.md
# OR
rm ~/.claude/agents/35-unpermitted-work-legalization.md
```
