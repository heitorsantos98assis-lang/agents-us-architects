# bim-revit-lod-modeling — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `49-bim-revit-lod-modeling.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 49-bim-revit-lod-modeling.zip
```
...
cp 49-bim-revit-lod-modeling.md .claude/agents/
...
```
Use the bim-revit-lod-modeling subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 49-bim-revit-lod-modeling.md
# OR
...
```bash
rm .claude/agents/49-bim-revit-lod-modeling.md
# OR
rm ~/.claude/agents/49-bim-revit-lod-modeling.md
```
