# bim-revit-lod-modeling — Codex Agent
...
cp 49-bim-revit-lod-modeling.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 49-bim-revit-lod-modeling.md
# OR
...
```bash
rm .codex/agents/49-bim-revit-lod-modeling.md
# OR
rm .codex/agents/49-bim-revit-lod-modeling.md
```
