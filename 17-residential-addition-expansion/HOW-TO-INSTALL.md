# 17-residential-addition-expansion — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `17-residential-addition-expansion.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 17-residential-addition-expansion.zip
```
...
cp 17-residential-addition-expansion.md .claude/agents/
...
```
Use the residential-addition-expansion subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 17-residential-addition-expansion.md
# OR
...
```bash
rm .claude/agents/17-residential-addition-expansion.md
# OR
rm ~/.claude/agents/17-residential-addition-expansion.md
```
