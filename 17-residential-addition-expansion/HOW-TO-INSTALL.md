# 17-residential-addition-expansion — Codex Agent
...
cp 17-residential-addition-expansion.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 17-residential-addition-expansion.md
# OR
...
```bash
rm .codex/agents/17-residential-addition-expansion.md
# OR
rm .codex/agents/17-residential-addition-expansion.md
```
