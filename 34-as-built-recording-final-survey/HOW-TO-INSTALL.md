# as-built-recording-final-survey — Codex Agent
...
cp 34-as-built-recording-final-survey.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 34-as-built-recording-final-survey.md
# OR
...
```bash
rm .codex/agents/34-as-built-recording-final-survey.md
# OR
rm .codex/agents/34-as-built-recording-final-survey.md
```
