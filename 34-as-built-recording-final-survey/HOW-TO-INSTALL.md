# as-built-recording-final-survey — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `34-as-built-recording-final-survey.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 34-as-built-recording-final-survey.zip
```
...
cp 34-as-built-recording-final-survey.md .claude/agents/
...
```
Use the as-built-recording-final-survey subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 34-as-built-recording-final-survey.md
# OR
...
```bash
rm .claude/agents/34-as-built-recording-final-survey.md
# OR
rm ~/.claude/agents/34-as-built-recording-final-survey.md
```
