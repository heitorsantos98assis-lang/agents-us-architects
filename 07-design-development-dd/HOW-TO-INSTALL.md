# 07-design-development-dd — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `07-design-development-dd.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 07-design-development-dd.zip
```
...
cp 07-design-development-dd.md .claude/agents/
...
```
Use the design-development-dd subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 07-design-development-dd.md
# OR
...
```bash
rm .claude/agents/07-design-development-dd.md
# OR
rm ~/.claude/agents/07-design-development-dd.md
```
