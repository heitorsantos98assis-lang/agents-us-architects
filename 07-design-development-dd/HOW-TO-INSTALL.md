# 07-design-development-dd — Codex Agent
...
cp 07-design-development-dd.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 07-design-development-dd.md
# OR
...
```bash
rm .codex/agents/07-design-development-dd.md
# OR
rm .codex/agents/07-design-development-dd.md
```
