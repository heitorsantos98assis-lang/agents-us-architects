# 16-residential-renovation-alteration — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `16-residential-renovation-alteration.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 16-residential-renovation-alteration.zip
```
...
cp 16-residential-renovation-alteration.md .claude/agents/
...
```
Use the residential-renovation-alteration subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 16-residential-renovation-alteration.md
# OR
...
```bash
rm .claude/agents/16-residential-renovation-alteration.md
# OR
rm ~/.claude/agents/16-residential-renovation-alteration.md
```
