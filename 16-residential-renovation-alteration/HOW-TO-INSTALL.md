# 16-residential-renovation-alteration — Codex Agent
...
cp 16-residential-renovation-alteration.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 16-residential-renovation-alteration.md
# OR
...
```bash
rm .codex/agents/16-residential-renovation-alteration.md
# OR
rm .codex/agents/16-residential-renovation-alteration.md
```
