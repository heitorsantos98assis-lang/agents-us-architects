# sustainability-leed-well-phius-lbc — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `46-sustainability-leed-well-phius-lbc.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 46-sustainability-leed-well-phius-lbc.zip
```
...
cp 46-sustainability-leed-well-phius-lbc.md .claude/agents/
...
```
Use the sustainability-leed-well-phius-lbc subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 46-sustainability-leed-well-phius-lbc.md
# OR
...
```bash
rm .claude/agents/46-sustainability-leed-well-phius-lbc.md
# OR
rm ~/.claude/agents/46-sustainability-leed-well-phius-lbc.md
```
