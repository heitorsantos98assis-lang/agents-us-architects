# sustainability-leed-well-phius-lbc — Codex Agent
...
cp 46-sustainability-leed-well-phius-lbc.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 46-sustainability-leed-well-phius-lbc.md
# OR
...
```bash
rm .codex/agents/46-sustainability-leed-well-phius-lbc.md
# OR
rm .codex/agents/46-sustainability-leed-well-phius-lbc.md
```
