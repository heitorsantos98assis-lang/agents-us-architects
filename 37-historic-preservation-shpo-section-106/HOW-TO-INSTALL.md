# historic-preservation-shpo-section-106 — Codex Agent
...
cp 37-historic-preservation-shpo-section-106.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 37-historic-preservation-shpo-section-106.md
# OR
...
```bash
rm .codex/agents/37-historic-preservation-shpo-section-106.md
# OR
rm .codex/agents/37-historic-preservation-shpo-section-106.md
```
