# historic-preservation-shpo-section-106 — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `37-historic-preservation-shpo-section-106.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 37-historic-preservation-shpo-section-106.zip
```
...
cp 37-historic-preservation-shpo-section-106.md .claude/agents/
...
```
Use the historic-preservation-shpo-section-106 subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 37-historic-preservation-shpo-section-106.md
# OR
...
```bash
rm .claude/agents/37-historic-preservation-shpo-section-106.md
# OR
rm ~/.claude/agents/37-historic-preservation-shpo-section-106.md
```
