# 20-restaurant-bar-food-service-design — Codex Agent
...
cp 20-restaurant-bar-food-service-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 20-restaurant-bar-food-service-design.md
# OR
...
```bash
rm .codex/agents/20-restaurant-bar-food-service-design.md
# OR
rm .codex/agents/20-restaurant-bar-food-service-design.md
```
