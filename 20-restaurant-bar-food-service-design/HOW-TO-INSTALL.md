# 20-restaurant-bar-food-service-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `20-restaurant-bar-food-service-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 20-restaurant-bar-food-service-design.zip
```
...
cp 20-restaurant-bar-food-service-design.md .claude/agents/
...
```
Use the restaurant-bar-food-service-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 20-restaurant-bar-food-service-design.md
# OR
...
```bash
rm .claude/agents/20-restaurant-bar-food-service-design.md
# OR
rm ~/.claude/agents/20-restaurant-bar-food-service-design.md
```
