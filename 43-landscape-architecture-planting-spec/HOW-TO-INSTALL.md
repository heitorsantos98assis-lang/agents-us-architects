# landscape-architecture-planting-spec — Codex Agent
...
cp 43-landscape-architecture-planting-spec.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 43-landscape-architecture-planting-spec.md
# OR
...
```bash
rm .codex/agents/43-landscape-architecture-planting-spec.md
# OR
rm .codex/agents/43-landscape-architecture-planting-spec.md
```
