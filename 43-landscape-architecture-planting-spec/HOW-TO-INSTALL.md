# landscape-architecture-planting-spec — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `43-landscape-architecture-planting-spec.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 43-landscape-architecture-planting-spec.zip
```
...
cp 43-landscape-architecture-planting-spec.md .claude/agents/
...
```
Use the landscape-architecture-planting-spec subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 43-landscape-architecture-planting-spec.md
# OR
...
```bash
rm .claude/agents/43-landscape-architecture-planting-spec.md
# OR
rm ~/.claude/agents/43-landscape-architecture-planting-spec.md
```
