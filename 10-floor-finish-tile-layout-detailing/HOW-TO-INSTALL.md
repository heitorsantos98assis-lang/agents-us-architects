# 10-floor-finish-tile-layout-detailing — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `10-floor-finish-tile-layout-detailing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 10-floor-finish-tile-layout-detailing.zip
```
...
cp 10-floor-finish-tile-layout-detailing.md .claude/agents/
...
```
Use the floor-finish-tile-layout-detailing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 10-floor-finish-tile-layout-detailing.md
# OR
...
```bash
rm .claude/agents/10-floor-finish-tile-layout-detailing.md
# OR
rm ~/.claude/agents/10-floor-finish-tile-layout-detailing.md
```
