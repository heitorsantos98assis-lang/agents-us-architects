# 10-floor-finish-tile-layout-detailing — Codex Agent
...
cp 10-floor-finish-tile-layout-detailing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 10-floor-finish-tile-layout-detailing.md
# OR
...
```bash
rm .codex/agents/10-floor-finish-tile-layout-detailing.md
# OR
rm .codex/agents/10-floor-finish-tile-layout-detailing.md
```
