# facade-retrofit-energy-efficiency — Codex Agent
...
cp 47-facade-retrofit-energy-efficiency.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 47-facade-retrofit-energy-efficiency.md
# OR
...
```bash
rm .codex/agents/47-facade-retrofit-energy-efficiency.md
# OR
rm .codex/agents/47-facade-retrofit-energy-efficiency.md
```
