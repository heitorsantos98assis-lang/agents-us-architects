# facade-retrofit-energy-efficiency — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `47-facade-retrofit-energy-efficiency.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 47-facade-retrofit-energy-efficiency.zip
```
...
cp 47-facade-retrofit-energy-efficiency.md .claude/agents/
...
```
Use the facade-retrofit-energy-efficiency subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 47-facade-retrofit-energy-efficiency.md
# OR
...
```bash
rm .claude/agents/47-facade-retrofit-energy-efficiency.md
# OR
rm ~/.claude/agents/47-facade-retrofit-energy-efficiency.md
```
