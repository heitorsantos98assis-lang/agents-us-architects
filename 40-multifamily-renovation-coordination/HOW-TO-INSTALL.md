# multifamily-renovation-coordination — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `40-multifamily-renovation-coordination.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 40-multifamily-renovation-coordination.zip
```
...
cp 40-multifamily-renovation-coordination.md .claude/agents/
...
```
Use the multifamily-renovation-coordination subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 40-multifamily-renovation-coordination.md
# OR
...
```bash
rm .claude/agents/40-multifamily-renovation-coordination.md
# OR
rm ~/.claude/agents/40-multifamily-renovation-coordination.md
```
