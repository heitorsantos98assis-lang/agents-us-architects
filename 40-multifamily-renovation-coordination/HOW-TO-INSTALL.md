# multifamily-renovation-coordination — Codex Agent
...
cp 40-multifamily-renovation-coordination.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 40-multifamily-renovation-coordination.md
# OR
...
```bash
rm .codex/agents/40-multifamily-renovation-coordination.md
# OR
rm .codex/agents/40-multifamily-renovation-coordination.md
```
