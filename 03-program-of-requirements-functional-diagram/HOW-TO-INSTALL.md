# 03-program-of-requirements-functional-diagram — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `03-program-of-requirements-functional-diagram.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 03-program-of-requirements-functional-diagram.zip
```
...
cp 03-program-of-requirements-functional-diagram.md .claude/agents/
...
```
Use the program-of-requirements-functional-diagram subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 03-program-of-requirements-functional-diagram.md
# OR
...
```bash
rm .claude/agents/03-program-of-requirements-functional-diagram.md
# OR
rm ~/.claude/agents/03-program-of-requirements-functional-diagram.md
```
