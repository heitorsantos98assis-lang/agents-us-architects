# 03-program-of-requirements-functional-diagram — Codex Agent
...
cp 03-program-of-requirements-functional-diagram.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 03-program-of-requirements-functional-diagram.md
# OR
...
```bash
rm .codex/agents/03-program-of-requirements-functional-diagram.md
# OR
rm .codex/agents/03-program-of-requirements-functional-diagram.md
```
