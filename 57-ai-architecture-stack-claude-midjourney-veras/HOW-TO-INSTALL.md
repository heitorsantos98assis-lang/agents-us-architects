# ai-architecture-stack-claude-midjourney-veras — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `57-ai-architecture-stack-claude-midjourney-veras.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 57-ai-architecture-stack-claude-midjourney-veras.zip
```
...
cp 57-ai-architecture-stack-claude-midjourney-veras.md .claude/agents/
...
```
Use the ai-architecture-stack-claude-midjourney-veras subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 57-ai-architecture-stack-claude-midjourney-veras.md
# OR
...
```bash
rm .claude/agents/57-ai-architecture-stack-claude-midjourney-veras.md
# OR
rm ~/.claude/agents/57-ai-architecture-stack-claude-midjourney-veras.md
```
