# 26-finish-specification-binder — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `26-finish-specification-binder.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 26-finish-specification-binder.zip
```
...
cp 26-finish-specification-binder.md .claude/agents/
...
```
Use the finish-specification-binder subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 26-finish-specification-binder.md
# OR
...
```bash
rm .claude/agents/26-finish-specification-binder.md
# OR
rm ~/.claude/agents/26-finish-specification-binder.md
```
