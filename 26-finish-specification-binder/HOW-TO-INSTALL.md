# 26-finish-specification-binder — Codex Agent
...
cp 26-finish-specification-binder.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 26-finish-specification-binder.md
# OR
...
```bash
rm .codex/agents/26-finish-specification-binder.md
# OR
rm .codex/agents/26-finish-specification-binder.md
```
