# 15-millwork-fixed-furniture-detailing — Codex Agent
...
cp 15-millwork-fixed-furniture-detailing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 15-millwork-fixed-furniture-detailing.md
# OR
...
```bash
rm .codex/agents/15-millwork-fixed-furniture-detailing.md
# OR
rm .codex/agents/15-millwork-fixed-furniture-detailing.md
```
