# 15-millwork-fixed-furniture-detailing — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `15-millwork-fixed-furniture-detailing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 15-millwork-fixed-furniture-detailing.zip
```
...
cp 15-millwork-fixed-furniture-detailing.md .claude/agents/
...
```
Use the millwork-fixed-furniture-detailing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 15-millwork-fixed-furniture-detailing.md
# OR
...
```bash
rm .claude/agents/15-millwork-fixed-furniture-detailing.md
# OR
rm ~/.claude/agents/15-millwork-fixed-furniture-detailing.md
```
