# building-performance-standards — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `38-building-performance-standards.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 38-building-performance-standards.zip
```
...
cp 38-building-performance-standards.md .claude/agents/
...
```
Use the building-performance-standards subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 38-building-performance-standards.md
# OR
...
```bash
rm .claude/agents/38-building-performance-standards.md
# OR
rm ~/.claude/agents/38-building-performance-standards.md
```
