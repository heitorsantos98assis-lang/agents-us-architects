# building-performance-standards — Codex Agent
...
cp 38-building-performance-standards.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 38-building-performance-standards.md
# OR
...
```bash
rm .codex/agents/38-building-performance-standards.md
# OR
rm .codex/agents/38-building-performance-standards.md
```
