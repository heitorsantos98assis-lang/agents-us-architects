# 23-residential-interior-design — Codex Agent
...
cp 23-residential-interior-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 23-residential-interior-design.md
# OR
...
```bash
rm .codex/agents/23-residential-interior-design.md
# OR
rm .codex/agents/23-residential-interior-design.md
```
