# 23-residential-interior-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `23-residential-interior-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 23-residential-interior-design.zip
```
...
cp 23-residential-interior-design.md .claude/agents/
...
```
Use the residential-interior-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 23-residential-interior-design.md
# OR
...
```bash
rm .claude/agents/23-residential-interior-design.md
# OR
rm ~/.claude/agents/23-residential-interior-design.md
```
