# 12-stairs-guardrails-handrails-detailing — Codex Agent
...
cp 12-stairs-guardrails-handrails-detailing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 12-stairs-guardrails-handrails-detailing.md
# OR
...
```bash
rm .codex/agents/12-stairs-guardrails-handrails-detailing.md
# OR
rm .codex/agents/12-stairs-guardrails-handrails-detailing.md
```
