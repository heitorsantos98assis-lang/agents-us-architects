# 12-stairs-guardrails-handrails-detailing — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `12-stairs-guardrails-handrails-detailing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 12-stairs-guardrails-handrails-detailing.zip
```
...
cp 12-stairs-guardrails-handrails-detailing.md .claude/agents/
...
```
Use the stairs-guardrails-handrails-detailing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 12-stairs-guardrails-handrails-detailing.md
# OR
...
```bash
rm .claude/agents/12-stairs-guardrails-handrails-detailing.md
# OR
rm ~/.claude/agents/12-stairs-guardrails-handrails-detailing.md
```
