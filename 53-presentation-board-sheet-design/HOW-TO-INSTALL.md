# presentation-board-sheet-design — Codex Agent
...
cp 53-presentation-board-sheet-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 53-presentation-board-sheet-design.md
# OR
...
```bash
rm .codex/agents/53-presentation-board-sheet-design.md
# OR
rm .codex/agents/53-presentation-board-sheet-design.md
```
