# presentation-board-sheet-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `53-presentation-board-sheet-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 53-presentation-board-sheet-design.zip
```
...
cp 53-presentation-board-sheet-design.md .claude/agents/
...
```
Use the presentation-board-sheet-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 53-presentation-board-sheet-design.md
# OR
...
```bash
rm .claude/agents/53-presentation-board-sheet-design.md
# OR
rm ~/.claude/agents/53-presentation-board-sheet-design.md
```
