# architect-of-record-seal-sign-protocol — Codex Agent
...
cp 56-architect-of-record-seal-sign-protocol.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 56-architect-of-record-seal-sign-protocol.md
# OR
...
```bash
rm .codex/agents/56-architect-of-record-seal-sign-protocol.md
# OR
rm .codex/agents/56-architect-of-record-seal-sign-protocol.md
```
