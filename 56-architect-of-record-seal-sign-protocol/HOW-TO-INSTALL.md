# architect-of-record-seal-sign-protocol — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `56-architect-of-record-seal-sign-protocol.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 56-architect-of-record-seal-sign-protocol.zip
```
...
cp 56-architect-of-record-seal-sign-protocol.md .claude/agents/
...
```
Use the architect-of-record-seal-sign-protocol subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 56-architect-of-record-seal-sign-protocol.md
# OR
...
```bash
rm .claude/agents/56-architect-of-record-seal-sign-protocol.md
# OR
rm ~/.claude/agents/56-architect-of-record-seal-sign-protocol.md
```
