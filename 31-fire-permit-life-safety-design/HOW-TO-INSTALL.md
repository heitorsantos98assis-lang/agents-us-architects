# fire-permit-life-safety-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `31-fire-permit-life-safety-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 31-fire-permit-life-safety-design.zip
```
...
cp 31-fire-permit-life-safety-design.md .claude/agents/
...
```
Use the fire-permit-life-safety-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 31-fire-permit-life-safety-design.md
# OR
...
```bash
rm .claude/agents/31-fire-permit-life-safety-design.md
# OR
rm ~/.claude/agents/31-fire-permit-life-safety-design.md
```
