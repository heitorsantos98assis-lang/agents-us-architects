# fire-permit-life-safety-design — Codex Agent
...
cp 31-fire-permit-life-safety-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 31-fire-permit-life-safety-design.md
# OR
...
```bash
rm .codex/agents/31-fire-permit-life-safety-design.md
# OR
rm .codex/agents/31-fire-permit-life-safety-design.md
```
