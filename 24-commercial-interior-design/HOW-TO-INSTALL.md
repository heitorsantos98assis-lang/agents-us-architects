# 24-commercial-interior-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `24-commercial-interior-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 24-commercial-interior-design.zip
```
...
cp 24-commercial-interior-design.md .claude/agents/
...
```
Use the commercial-interior-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 24-commercial-interior-design.md
# OR
...
```bash
rm .claude/agents/24-commercial-interior-design.md
# OR
rm ~/.claude/agents/24-commercial-interior-design.md
```
