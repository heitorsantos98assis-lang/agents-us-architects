# 24-commercial-interior-design — Codex Agent
...
cp 24-commercial-interior-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 24-commercial-interior-design.md
# OR
...
```bash
rm .codex/agents/24-commercial-interior-design.md
# OR
rm .codex/agents/24-commercial-interior-design.md
```
