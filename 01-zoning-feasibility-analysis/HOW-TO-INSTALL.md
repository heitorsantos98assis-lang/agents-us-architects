# 01-zoning-feasibility-analysis — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `01-zoning-feasibility-analysis.md` for the full description, frameworks, reference tables, and operating flow.
...
cp 01-zoning-feasibility-analysis.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 01-zoning-feasibility-analysis.md
# OR
...
```bash
rm .claude/agents/01-zoning-feasibility-analysis.md
# OR
rm ~/.claude/agents/01-zoning-feasibility-analysis.md
```
