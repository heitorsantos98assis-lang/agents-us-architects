# 01-zoning-feasibility-analysis — Codex Agent
...
cp 01-zoning-feasibility-analysis.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 01-zoning-feasibility-analysis.md
# OR
...
```bash
rm .codex/agents/01-zoning-feasibility-analysis.md
# OR
rm .codex/agents/01-zoning-feasibility-analysis.md
```
