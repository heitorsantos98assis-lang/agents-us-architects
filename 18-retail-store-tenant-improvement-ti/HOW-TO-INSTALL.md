# 18-retail-store-tenant-improvement-ti — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `18-retail-store-tenant-improvement-ti.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 18-retail-store-tenant-improvement-ti.zip
```
...
cp 18-retail-store-tenant-improvement-ti.md .claude/agents/
...
```
Use the retail-store-tenant-improvement-ti subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 18-retail-store-tenant-improvement-ti.md
# OR
...
```bash
rm .claude/agents/18-retail-store-tenant-improvement-ti.md
# OR
rm ~/.claude/agents/18-retail-store-tenant-improvement-ti.md
```
