# bim-coordination-clash-detection — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `50-bim-coordination-clash-detection.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 50-bim-coordination-clash-detection.zip
```
...
cp 50-bim-coordination-clash-detection.md .claude/agents/
...
```
Use the bim-coordination-clash-detection subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 50-bim-coordination-clash-detection.md
# OR
...
```bash
rm .claude/agents/50-bim-coordination-clash-detection.md
# OR
rm ~/.claude/agents/50-bim-coordination-clash-detection.md
```
