# bim-coordination-clash-detection — Codex Agent
...
cp 50-bim-coordination-clash-detection.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 50-bim-coordination-clash-detection.md
# OR
...
```bash
rm .codex/agents/50-bim-coordination-clash-detection.md
# OR
rm .codex/agents/50-bim-coordination-clash-detection.md
```
