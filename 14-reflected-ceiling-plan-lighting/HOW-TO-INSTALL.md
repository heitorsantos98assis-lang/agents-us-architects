# 14-reflected-ceiling-plan-lighting — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `14-reflected-ceiling-plan-lighting.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 14-reflected-ceiling-plan-lighting.zip
```
...
cp 14-reflected-ceiling-plan-lighting.md .claude/agents/
...
```
Use the reflected-ceiling-plan-lighting subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 14-reflected-ceiling-plan-lighting.md
# OR
...
```bash
rm .claude/agents/14-reflected-ceiling-plan-lighting.md
# OR
rm ~/.claude/agents/14-reflected-ceiling-plan-lighting.md
```
