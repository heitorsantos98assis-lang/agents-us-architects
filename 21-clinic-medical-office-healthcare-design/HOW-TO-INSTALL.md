# 21-clinic-medical-office-healthcare-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `21-clinic-medical-office-healthcare-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 21-clinic-medical-office-healthcare-design.zip
```
...
cp 21-clinic-medical-office-healthcare-design.md .claude/agents/
...
```
Use the clinic-medical-office-healthcare-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 21-clinic-medical-office-healthcare-design.md
# OR
...
```bash
rm .claude/agents/21-clinic-medical-office-healthcare-design.md
# OR
rm ~/.claude/agents/21-clinic-medical-office-healthcare-design.md
```
