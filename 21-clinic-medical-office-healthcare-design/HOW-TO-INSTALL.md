# 21-clinic-medical-office-healthcare-design — Codex Agent
...
cp 21-clinic-medical-office-healthcare-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 21-clinic-medical-office-healthcare-design.md
# OR
...
```bash
rm .codex/agents/21-clinic-medical-office-healthcare-design.md
# OR
rm .codex/agents/21-clinic-medical-office-healthcare-design.md
```
