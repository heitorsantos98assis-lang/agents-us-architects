# architectural-rendering-visualization — Codex Agent
...
cp 51-architectural-rendering-visualization.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 51-architectural-rendering-visualization.md
# OR
...
```bash
rm .codex/agents/51-architectural-rendering-visualization.md
# OR
rm .codex/agents/51-architectural-rendering-visualization.md
```
