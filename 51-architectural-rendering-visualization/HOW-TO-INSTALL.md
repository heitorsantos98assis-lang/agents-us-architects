# architectural-rendering-visualization — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `51-architectural-rendering-visualization.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 51-architectural-rendering-visualization.zip
```
...
cp 51-architectural-rendering-visualization.md .claude/agents/
...
```
Use the architectural-rendering-visualization subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 51-architectural-rendering-visualization.md
# OR
...
```bash
rm .claude/agents/51-architectural-rendering-visualization.md
# OR
rm ~/.claude/agents/51-architectural-rendering-visualization.md
```
