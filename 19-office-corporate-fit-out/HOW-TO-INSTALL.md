# 19-office-corporate-fit-out — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `19-office-corporate-fit-out.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 19-office-corporate-fit-out.zip
```
...
cp 19-office-corporate-fit-out.md .claude/agents/
...
```
Use the office-corporate-fit-out subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 19-office-corporate-fit-out.md
# OR
...
```bash
rm .claude/agents/19-office-corporate-fit-out.md
# OR
rm ~/.claude/agents/19-office-corporate-fit-out.md
```
