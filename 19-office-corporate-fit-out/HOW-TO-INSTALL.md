# 19-office-corporate-fit-out — Codex Agent
...
cp 19-office-corporate-fit-out.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 19-office-corporate-fit-out.md
# OR
...
```bash
rm .codex/agents/19-office-corporate-fit-out.md
# OR
rm .codex/agents/19-office-corporate-fit-out.md
```
