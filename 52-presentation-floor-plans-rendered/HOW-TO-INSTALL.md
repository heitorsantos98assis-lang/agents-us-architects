# presentation-floor-plans-rendered — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `52-presentation-floor-plans-rendered.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 52-presentation-floor-plans-rendered.zip
```
...
cp 52-presentation-floor-plans-rendered.md .claude/agents/
...
```
Use the presentation-floor-plans-rendered subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 52-presentation-floor-plans-rendered.md
# OR
...
```bash
rm .claude/agents/52-presentation-floor-plans-rendered.md
# OR
rm ~/.claude/agents/52-presentation-floor-plans-rendered.md
```
