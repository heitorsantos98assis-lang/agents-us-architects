# presentation-floor-plans-rendered — Codex Agent
...
cp 52-presentation-floor-plans-rendered.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 52-presentation-floor-plans-rendered.md
# OR
...
```bash
rm .codex/agents/52-presentation-floor-plans-rendered.md
# OR
rm .codex/agents/52-presentation-floor-plans-rendered.md
```
