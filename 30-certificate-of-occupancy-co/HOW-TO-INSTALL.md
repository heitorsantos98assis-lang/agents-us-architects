# certificate-of-occupancy-co — Codex Agent
...
cp 30-certificate-of-occupancy-co.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 30-certificate-of-occupancy-co.md
# OR
...
```bash
rm .codex/agents/30-certificate-of-occupancy-co.md
# OR
rm .codex/agents/30-certificate-of-occupancy-co.md
```
