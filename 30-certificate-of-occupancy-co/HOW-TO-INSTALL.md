# certificate-of-occupancy-co — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `30-certificate-of-occupancy-co.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 30-certificate-of-occupancy-co.zip
```
...
cp 30-certificate-of-occupancy-co.md .claude/agents/
...
```
Use the certificate-of-occupancy-co subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 30-certificate-of-occupancy-co.md
# OR
...
```bash
rm .claude/agents/30-certificate-of-occupancy-co.md
# OR
rm ~/.claude/agents/30-certificate-of-occupancy-co.md
```
