# fee-proposal-aia-billing — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `54-fee-proposal-aia-billing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 54-fee-proposal-aia-billing.zip
```
...
cp 54-fee-proposal-aia-billing.md .claude/agents/
...
```
Use the fee-proposal-aia-billing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 54-fee-proposal-aia-billing.md
# OR
...
```bash
rm .claude/agents/54-fee-proposal-aia-billing.md
# OR
rm ~/.claude/agents/54-fee-proposal-aia-billing.md
```
