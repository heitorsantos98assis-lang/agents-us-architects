# fee-proposal-aia-billing — Codex Agent
...
cp 54-fee-proposal-aia-billing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 54-fee-proposal-aia-billing.md
# OR
...
```bash
rm .codex/agents/54-fee-proposal-aia-billing.md
# OR
rm .codex/agents/54-fee-proposal-aia-billing.md
```
