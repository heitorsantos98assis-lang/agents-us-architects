# building-permit-issuance-tracking — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `29-building-permit-issuance-tracking.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 29-building-permit-issuance-tracking.zip
```
...
cp 29-building-permit-issuance-tracking.md .claude/agents/
...
```
Use the building-permit-issuance-tracking subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 29-building-permit-issuance-tracking.md
# OR
...
```bash
rm .claude/agents/29-building-permit-issuance-tracking.md
# OR
rm ~/.claude/agents/29-building-permit-issuance-tracking.md
```
