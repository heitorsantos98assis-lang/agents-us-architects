# building-permit-issuance-tracking — Codex Agent
...
cp 29-building-permit-issuance-tracking.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 29-building-permit-issuance-tracking.md
# OR
...
```bash
rm .codex/agents/29-building-permit-issuance-tracking.md
# OR
rm .codex/agents/29-building-permit-issuance-tracking.md
```
