# 11-doors-windows-frames-detailing — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `11-doors-windows-frames-detailing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 11-doors-windows-frames-detailing.zip
```
...
cp 11-doors-windows-frames-detailing.md .claude/agents/
...
```
Use the doors-windows-frames-detailing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 11-doors-windows-frames-detailing.md
# OR
...
```bash
rm .claude/agents/11-doors-windows-frames-detailing.md
# OR
rm ~/.claude/agents/11-doors-windows-frames-detailing.md
```
