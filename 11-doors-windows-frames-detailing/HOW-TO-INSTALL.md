# 11-doors-windows-frames-detailing — Codex Agent
...
cp 11-doors-windows-frames-detailing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 11-doors-windows-frames-detailing.md
# OR
...
```bash
rm .codex/agents/11-doors-windows-frames-detailing.md
# OR
rm .codex/agents/11-doors-windows-frames-detailing.md
```
