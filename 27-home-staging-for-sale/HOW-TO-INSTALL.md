# 27-home-staging-for-sale — Codex Agent
...
cp 27-home-staging-for-sale.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 27-home-staging-for-sale.md
# OR
...
```bash
rm .codex/agents/27-home-staging-for-sale.md
# OR
rm .codex/agents/27-home-staging-for-sale.md
```
