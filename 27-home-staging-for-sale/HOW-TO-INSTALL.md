# 27-home-staging-for-sale — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `27-home-staging-for-sale.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 27-home-staging-for-sale.zip
```
...
cp 27-home-staging-for-sale.md .claude/agents/
...
```
Use the home-staging-for-sale subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 27-home-staging-for-sale.md
# OR
...
```bash
rm .claude/agents/27-home-staging-for-sale.md
# OR
rm ~/.claude/agents/27-home-staging-for-sale.md
```
