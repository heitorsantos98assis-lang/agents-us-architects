# drawing-set-organization-standards — Codex Agent
...
cp 42-drawing-set-organization-standards.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 42-drawing-set-organization-standards.md
# OR
...
```bash
rm .codex/agents/42-drawing-set-organization-standards.md
# OR
rm .codex/agents/42-drawing-set-organization-standards.md
```
