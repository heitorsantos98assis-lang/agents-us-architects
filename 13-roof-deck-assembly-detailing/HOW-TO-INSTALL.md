# 13-roof-deck-assembly-detailing — Codex Agent
...
cp 13-roof-deck-assembly-detailing.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 13-roof-deck-assembly-detailing.md
# OR
...
```bash
rm .codex/agents/13-roof-deck-assembly-detailing.md
# OR
rm .codex/agents/13-roof-deck-assembly-detailing.md
```
