# 13-roof-deck-assembly-detailing — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `13-roof-deck-assembly-detailing.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 13-roof-deck-assembly-detailing.zip
```
...
cp 13-roof-deck-assembly-detailing.md .claude/agents/
...
```
Use the roof-deck-assembly-detailing subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 13-roof-deck-assembly-detailing.md
# OR
...
```bash
rm .claude/agents/13-roof-deck-assembly-detailing.md
# OR
rm ~/.claude/agents/13-roof-deck-assembly-detailing.md
```
