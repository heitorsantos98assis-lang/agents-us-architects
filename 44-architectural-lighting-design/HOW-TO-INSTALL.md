# architectural-lighting-design — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `44-architectural-lighting-design.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 44-architectural-lighting-design.zip
```
...
cp 44-architectural-lighting-design.md .claude/agents/
...
```
Use the architectural-lighting-design subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 44-architectural-lighting-design.md
# OR
...
```bash
rm .claude/agents/44-architectural-lighting-design.md
# OR
rm ~/.claude/agents/44-architectural-lighting-design.md
```
