# architectural-lighting-design — Codex Agent
...
cp 44-architectural-lighting-design.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 44-architectural-lighting-design.md
# OR
...
```bash
rm .codex/agents/44-architectural-lighting-design.md
# OR
rm .codex/agents/44-architectural-lighting-design.md
```
