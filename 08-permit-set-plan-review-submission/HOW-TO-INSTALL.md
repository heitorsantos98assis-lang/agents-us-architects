# 08-permit-set-plan-review-submission — Codex Agent
...
cp 08-permit-set-plan-review-submission.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 08-permit-set-plan-review-submission.md
# OR
...
```bash
rm .codex/agents/08-permit-set-plan-review-submission.md
# OR
rm .codex/agents/08-permit-set-plan-review-submission.md
```
