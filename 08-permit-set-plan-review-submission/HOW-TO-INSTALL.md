# 08-permit-set-plan-review-submission — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (HL).

## What this agent does

See `08-permit-set-plan-review-submission.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 08-permit-set-plan-review-submission.zip
```
...
cp 08-permit-set-plan-review-submission.md .claude/agents/
...
```
Use the permit-set-plan-review-submission subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 08-permit-set-plan-review-submission.md
# OR
...
```bash
rm .claude/agents/08-permit-set-plan-review-submission.md
# OR
rm ~/.claude/agents/08-permit-set-plan-review-submission.md
```
