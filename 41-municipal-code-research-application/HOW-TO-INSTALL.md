# municipal-code-research-application — Codex Agent
...
cp 41-municipal-code-research-application.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 41-municipal-code-research-application.md
# OR
...
```bash
rm .codex/agents/41-municipal-code-research-application.md
# OR
rm .codex/agents/41-municipal-code-research-application.md
```
