# municipal-code-research-application — Claude Code Agent

A specialist subagent from the **57 Agents for US Architects** bundle (Bravy / ASV Digital).

## What this agent does

See `41-municipal-code-research-application.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 41-municipal-code-research-application.zip
```
...
cp 41-municipal-code-research-application.md .claude/agents/
...
```
Use the municipal-code-research-application subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 41-municipal-code-research-application.md
# OR
...
```bash
rm .claude/agents/41-municipal-code-research-application.md
# OR
rm ~/.claude/agents/41-municipal-code-research-application.md
```
